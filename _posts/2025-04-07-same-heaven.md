...
thumbnail: /assets/img/ikigai.png
---
...
{% include figure.liquid loading="eager" path="assets/img/horse_graph.png" class="img-fluid rounded z-depth-1" width="70%" %}
